...
public partial class GestaopiContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseMySql("server=localhost;port=3306;database=gestaopi;user=root;password=database78451296", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.32-mysql"));

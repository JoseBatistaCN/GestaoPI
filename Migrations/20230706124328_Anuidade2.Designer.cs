...
namespace GestaoPI.Migrations
{
    ...
    [Migration("20230706124328_Anuidade2")]
    partial class Anuidade2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GestaoPI.Models.DespachoMarca", b =>
                {
                    ...
                    b.HasOne("GestaoPI.Models.Revista", "Revista")
                        .WithMany("DespachosMarcas")
                        .HasForeignKey("NumeroRevista")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GestaoPI.Models.DespachoProgramaDeComputador", b =>
                {
                    ...
                    b.HasOne("GestaoPI.Models.Revista", "Revista")
                        .WithMany("DespachoProgramaDeComputadors")
                        .HasForeignKey("NumeroRevista")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GestaoPI.Models.Revista", b =>
                {
                    ...
                    b.Navigation("DespachoProgramaDeComputadors");

                    b.Navigation("DespachosMarcas");
                });
